...
<div class="page-container">
    <aside class="schedule-sidebar">
        <h2>새움학원 설명회</h2> <nav class="grade-nav">
            <ul>
                <li class:active={currentGrade === 'g1'}><a href="/seminar?grade=g1" on:click|preventDefault={() => { currentGrade = 'g1'; $page.url.searchParams.set('grade', 'g1'); }}>고1</a></li>
                <li class:active={currentGrade === 'g2'}><a href="/seminar?grade=g2" on:click|preventDefault={() => { currentGrade = 'g2'; $page.url.searchParams.set('grade', 'g2'); }}>고2</a></li>
                <li class:active={currentGrade === 'g3'}><a href="/seminar?grade=g3" on:click|preventDefault={() => { currentGrade = 'g3'; $page.url.searchParams.set('grade', 'g3'); }}>고3</a></li>
                <li class:active={currentGrade === 'm3'}><a href="/seminar?grade=m3" on:click|preventDefault={() => { currentGrade = 'm3'; $page.url.searchParams.set('grade', 'm3'); }}>중3</a></li>
            </ul>
        </nav>
    </aside>
    ...
    <section class="schedule-content">
        ...
        <div class="search-container">
            ...
            <button class="write-button common-button" on:click={handleWriteButtonClick}>글쓰기</button>
        </div>
    </section>
</div>
